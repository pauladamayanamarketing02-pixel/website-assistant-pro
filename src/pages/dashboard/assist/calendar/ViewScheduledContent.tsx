    ...
    const loadMetaAndItem = async () => {
      ...
      try {
        ...
        setItem({
          ...
          contentTypeName: (data.content_types?.name ?? "") as string,
          categoryId: (data.category_id ?? "") as string,
          categoryName: (data.content_categories?.name ?? "") as string,
          platform: (data.platform ?? null) as string | null,
          businessName: (data.businesses?.business_name ?? null) as string | null,
          businessId: (data.business_id ?? "") as string,
          businessUserId: (data.businesses?.user_id ?? "") as string,
