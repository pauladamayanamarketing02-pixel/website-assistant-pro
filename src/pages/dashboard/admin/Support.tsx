    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Semua pesan dari halaman /contact.</p>
        </div>
      ...
      <Card>
        <CardHeader className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Klik "View" untuk lihat detail & tandai selesai.</p>
        </CardHeader>
                          ...
                          <DialogContent className="max-w-2xl">
                            ...
                            <DialogFooter className="gap-2 sm:gap-0">
                              <Button
                                ...
                                disabled={String((selected?.id === r.id ? selected.status : r.status)).toLowerCase() === "resolved"}
                              >
