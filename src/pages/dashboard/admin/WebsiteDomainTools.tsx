...
// Stored in dedicated table `order_promos`
    ...
    try {
      ...
      const parsed: PromoDbRow[] = Array.isArray(data)
        ? (data as any[]).map((r) => ({
            ...
            discount_type: (String(r?.discount_type ?? "percentage").trim().toLowerCase() as PromoDiscountType) || "percentage",
            ...
            <CardContent className="space-y-3">
              ...
              <div className="grid gap-3 rounded-md border bg-muted/20 p-3 md:grid-cols-12">
                ...
                <div className="md:col-span-3">
                  ...
                  <Input
                    value={promoDraft.promo_name}
                    onChange={(e) => setPromoDraft((s) => ({ ...s, promo_name: e.target.value }))}
                ...
                <div className="md:col-span-3">
                  ...
                  <Input
                    value={promoDraft.event_name}
                    onChange={(e) => setPromoDraft((s) => ({ ...s, event_name: e.target.value }))}
                    disabled={promosSaving}
                  />
                </div>
                <div className="md:col-span-3">
                  ...
                  <Input
                    ...
                    onChange={(e) => setPromoDraft((s) => ({ ...s, description: e.target.value }))}
                    disabled={promosSaving}
                  />
                </div>
                ...
                <div className="md:col-span-3">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setPromoDraft((s) => ({ ...s, discount_type: v as PromoDiscountType }))}
                  >
                    <SelectTrigger disabled={promosSaving}>
                      <SelectValue />
                    </SelectTrigger>
